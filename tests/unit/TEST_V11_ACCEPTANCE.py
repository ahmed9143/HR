...
_bw = ROOT/"BUILD_WINDOWS.bat"
ok("Windows EXE build script", _bw.exists()
   and "HR_Enterprise.spec" in _bw.read_text(encoding="utf-8", errors="ignore")
   and (ROOT/"HR_Enterprise.spec").exists())
